# -*- coding: utf-8 -*-
"""
Created on Thu Oct  2 09:25:26 2025
...
class OptoProtocol100ms:
    ...
    def start(self):
        print('Optotagging protocol 100ms starting')
    ...
    def stop(self):
        print("Stopping Passive Optotagging Protocol 100ms...")
        self.running = False
