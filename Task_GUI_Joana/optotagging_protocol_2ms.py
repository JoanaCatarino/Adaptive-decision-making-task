# -*- coding: utf-8 -*-
"""
Created on Fri Oct  3 15:49:50 2025
...
class OptoProtocol2ms:
    ...
    def start(self):
        print('Optotagging protocol 2ms starting')
    ...
    def stop(self):
        print("Stopping Passive Optotagging Protocol 2ms...")
        self.running = False
