# -*- coding: utf-8 -*-
"""
Created on Fri Jul 25 11:28:16 2025
...
class PressSamplingTask:
    ...
    def reward(self, side):
        ...
        # Switch rewarded spout after every 5 trials
        if self.trial_counter >=5:
            ...
            print (f'Switching reward spout to {self.current_reward_spout} for next 5 trials')
