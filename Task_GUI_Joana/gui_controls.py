...
class GuiControls:
    ...
    def setup_piezo_plots(self):
        ...
        self.live_plot2 = LivePlotWidget(self.piezo_reader.max_data_points, parent=self.ui.plt_LickTrace_Right)
    ...
    def update_total_trials(self, total_trials):
        ...
        self.ui.box_TotalLicks.setText(f'{total_trials}')
        self.ui.OV_box_TotalLicks.setText(f'{total_trials}')
