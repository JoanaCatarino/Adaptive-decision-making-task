...
class GuiControls:
    ...
    def setup_piezo_plots(self):
        ...
        self.live_plot1 = LivePlotWidget(self.piezo_reader.max_data_points, color= 'red', parent=self.ui.plt_LickTrace_Left)
        ...
        self.live_plot2 = LivePlotWidget(self.piezo_reader.max_data_points, color= 'green', parent=self.ui.plt_LickTrace_Right)
