...
def create_data_file(date_label, animal_id_combobox, task_combobox, box_combobox):
    ...
    headers = ["trial_number", "trial_start", "trial_end", "trial_duration", "ITI", "block", "block_size", "early_lick",
               "stim", "8KHz", "16KHz", "lick", "left_spout", "right_spout", "lick_time", "reward",
               "punishment", "omission", "RW_start", "RW", "QW", "WW", "valve_opening", "ITImin", "ITImax",
